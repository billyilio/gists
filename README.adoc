...
create (:Service:Rest{endpoint:'http://hotels_v1.staging.api.e-travel.gr',name:'hotels_v1'});
create (:Service:Rest{endpoint:'http://hotels_v2.staging.api.e-travel.gr',name:'hotels_v2'});
...
create (:Servide{name:'test_accelerators'});
...
match (a:Sqs{name:'iur_test_accelerators'}), (b: {name:'test_accelerators'})
create (a)-[:SENDS_TO]->(b);
