...
create (:Background_worker,name:'Hotels_x_sell_emailer');
create (:Background_process,name:'AIR_IUR_posters');
create (:Service{endpoint:'http://refundservice-v1.staging.api.e-travel.gr/',name:'AIR_IUR_posters'});
